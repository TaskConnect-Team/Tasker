            ...
            {/* {tasks.map((task) => {
              ...
              return (
                <div
                  ...
                  className="flex justify-between rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-lg  transition-all"
                >
                  <div >
                    ...
                    <div className='flex flex-col items-start gap-2'>
                      ...
                      <button
                        ...
                        className="mt-2 rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold text-black hover:bg-slate-100"
                      >
                  ...
                  <div className="flex flex-col items-center justify-between gap-2">
                    <div className="text-sm font-semibold text-slate-900">Rs. {task.price}</div>
                    <button
                      type="button"
                      onClick={() => navigate(`/tasks/${task._id}`)}
                      className="rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold text-black hover:bg-slate-100"
                    >
                      View Details
                    </button>
                  </div>
